...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_ZFBFFC",
  selectorType = SelectorType.TAG,
  selectorExpression = "ZFBFFC"
)
public class SyncZFBFFCLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "ZFBFFC";
}