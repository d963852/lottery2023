...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_XYFT",
  selectorType = SelectorType.TAG,
  selectorExpression = "XYFT"
)
public class SyncXYFTLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "XYFT";
}