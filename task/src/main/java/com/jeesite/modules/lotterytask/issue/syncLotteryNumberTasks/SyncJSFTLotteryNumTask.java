...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_JSFT",
  selectorType = SelectorType.TAG,
  selectorExpression = "JSFT"
)
public class SyncJSFTLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "JSFT";
}