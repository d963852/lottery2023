...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_JSSC",
  selectorType = SelectorType.TAG,
  selectorExpression = "JSSC"
)
public class SyncJSSCLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "JSSC";
}