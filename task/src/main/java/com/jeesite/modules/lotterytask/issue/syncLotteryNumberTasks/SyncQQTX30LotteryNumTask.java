...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_QQTX30",
  selectorType = SelectorType.TAG,
  selectorExpression = "QQTX30"
)
public class SyncQQTX30LotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "QQTX30";
}