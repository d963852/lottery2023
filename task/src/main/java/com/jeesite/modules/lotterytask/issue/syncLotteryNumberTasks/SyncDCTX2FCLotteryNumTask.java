...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_DCTX2FC",
  selectorType = SelectorType.TAG,
  selectorExpression = "DCTX2FC"
)
public class SyncDCTX2FCLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "DCTX2FC";
}