...
public class IssueController extends BaseController {
    ...
    @ResponseBody
    public Page<Issue> lotteryNumberListData(Issue issue, HttpServletRequest request, HttpServletResponse response) {
        issue.setPage(new Page<>(request, response));
        Page<Issue> page = issueService.findPage(issue);
        return page;
    }
     ...
     */
    @RequiresPermissions("lotterycore:issue:view")
    @RequestMapping(value = "lotteryNumberForm")
    public String lotteryNumberForm(Issue issue, Model model) {
        model.addAttribute("issue", issue);
        return "modules/lotterycore/lotteryNumberForm";
    }
