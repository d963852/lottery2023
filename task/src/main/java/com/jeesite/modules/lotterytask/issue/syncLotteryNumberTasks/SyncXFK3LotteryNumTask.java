...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_XFK3",
  selectorType = SelectorType.TAG,
  selectorExpression = "XFK3"
)
public class SyncXFK3LotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "XFK3";
}