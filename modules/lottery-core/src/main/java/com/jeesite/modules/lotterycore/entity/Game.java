...
@Table(name = "game", alias = "a", label = "游戏信息", columns = {
        ...
        @Column(name = "game_category_id", attrName = "gameCategoryId", label = "对应游戏类别id", isQuery = false),
...
public class Game extends DataEntity<Game> {
    ...
    private Integer lotteryNumberCount;        // 排序号
    private Integer lotteryNumberMin;        // 排序号
    private Integer lotteryNumberMax;        // 排序号
