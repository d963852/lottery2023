...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_XFFFC",
  selectorType = SelectorType.TAG,
  selectorExpression = "XFFFC"
)
public class SyncXFFFCLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "XFFFC";
}