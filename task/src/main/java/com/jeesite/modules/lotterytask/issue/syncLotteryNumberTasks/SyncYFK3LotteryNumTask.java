...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_YFK3",
  selectorType = SelectorType.TAG,
  selectorExpression = "YFK3"
)
public class SyncYFK3LotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "YFK3";
}