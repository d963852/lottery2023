...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_HNK3",
  selectorType = SelectorType.TAG,
  selectorExpression = "HNK3"
)
public class SyncHNK3LotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "HNK3";
}