...
public class AccountChangeLogService extends CrudService<AccountChangeLogDao, AccountChangeLog> {
	 ...
	 */
	@Transactional
	public void add(Member member,double amount,String changeType,String ActionAccount,String bizType,String bizId){
