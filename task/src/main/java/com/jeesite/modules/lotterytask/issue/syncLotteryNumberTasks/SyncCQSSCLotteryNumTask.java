...
@RocketMQMessageListener(
  ...
  consumerGroup = "LotteryConsumerGroup_CQSSC",
  selectorType = SelectorType.TAG,
  selectorExpression = "CQSSC"
)
public class SyncCQSSCLotteryNumTask extends BaseSyncLotteryNumTask {
  public String GAME_CODE = "CQSSC";
}